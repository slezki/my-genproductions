...
initSEED = 23400 + 3 * 1
Nevents = 1000000
NameFile = 'py6-chic-full'
#
import FWCore.ParameterSet.Config as cms

sel_Chib_fileName = cms.untracked.string('sel-'+NameFile+'.root')
gen_Chib_fileName = cms.untracked.string('gen-'+NameFile+'.root')
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            operates_on_particles = cms.vint32(20443,445),   #chi_c1,chi_c2
...
process.ProductionFilterSequence = cms.Sequence(process.generator*process.oniafilter*process.muplusfilter*process.muminusfilter)
