...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA8_Chic1ToJpsiGamma_FilterJpsiGamma-all_7TeV_GEN.root'),					
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        pythia8ProcessSettings = cms.vstring(
         ...
         'StringFlav:mesonCL1S0J1 = 0.162',            # probability that a meson with S=0 is produced with L=1, J=1',
         'StringFlav:mesonCL1S1J0 = 0.018',            # probability that a meson with S=1 is produced with L=1, J=0',
         'StringFlav:mesonCL1S1J1 = 0.054',            # probability that a meson with S=1 is produced with L=1, J=1',
         ...
         '445:onIfAny = 83 -83',                       # let Chi_c2 -> rndmflavor bar-rndmflavor
         '10441:onMode = off',                         # Turn off Chi_c0 
         '10441:onIfAny = 83 -83',                     # let Chi_c0 -> rndmflavor bar-rndmflavor
