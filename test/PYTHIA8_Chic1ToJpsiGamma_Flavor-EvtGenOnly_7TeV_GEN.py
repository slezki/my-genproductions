...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA8_Chic1ToJpsiGamma_Flavor-EvtGenOnly_7TeV_GEN.root'),					
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/POnia_mumugamma.dec'),
