...
# with command line options: Configuration/Generator/python/ChiC_8TeV_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:7E33v2 --conditions auto:startup_7E33v2 --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 100000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/ChiC_8TeV_cfi.py nevts:100000'),
