# cfg file for Chi_{b1,b2}(2P) -> Upsilon(1S) gamma,  we are neglecting Chi_b0. Masses and widths are matched between pythia, evtgen and PDG 2016
#
...
pwaveMassfilter = cms.EDFilter("MCParticlePairFilter",
    ...
    MinInvMass = cms.untracked.double(10.25),
    MaxInvMass = cms.untracked.double(10.27),
)
